...
parser.add_argument('--input_sopa', type=int, help='input dimension to sopa', default='100')
...
from Thiti_Model import Sopa_SGH_leakyrelu as Sopa_SGH 
from Thiti_Model import my_utils
from resources.utils import metrics
from Thiti_Model.Sopa_SGH_leakyrelu import train_reg_str
from Thiti_Model import Sopa_SGH_leakyrelu as Sopa_Decomp
from Thiti_Model.my_utils import remove_old,to_file,enable_gradient_clipping
from Thiti_Model.Sopa_SGH_leakyrelu import SoPa_MLP as SoPa_MLP
...
batch_loss = []
max_auprc = 0
file_name = os.path.join('./saved_weights',args.file_name)
