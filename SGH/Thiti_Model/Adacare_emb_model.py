...
class AdaCare(nn.Module):
    def __init__(self, hidden_dim=128, kernel_size=2, kernel_num=64, input_dim=76, output_dim=1, dropout=0.5, r_v=4, r_c=4, activation='sigmoid',emb_dim=100, device='cuda'):
        ...
        self.nn_conv1 = CausalConv1d(emb_dim, kernel_num, kernel_size, 1, 1)
        self.nn_conv3 = CausalConv1d(emb_dim, kernel_num, kernel_size, 1, 3)
        self.nn_conv5 = CausalConv1d(emb_dim, kernel_num, kernel_size, 1, 5)
        ...
        self.nn_inputse = Recalibration(emb_dim, r_v, use_h=False, use_c=True, activation=activation)
        self.rnn = nn.GRUCell(emb_dim+3*kernel_num, hidden_dim)
